...
//
function sum(michaelArr) {
  if(michaelArr.length > 0 && typeof michaelArr !== 'string') {
    var sumOfNums = 0;
    for (var i = 0; i < michaelArr.length; i++) {
      sumOfNums = sumOfNums + michaelArr[i]
    }
    return sumOfNums;
  } else {
    console.error("Must give function an array");
  }
